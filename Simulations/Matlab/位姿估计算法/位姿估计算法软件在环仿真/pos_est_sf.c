 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sat Nov 29 18:57:41 2025
 */
...
/* Output Port  5 */
#define OUT_PORT_5_NAME                alt_acc
#define OUTPUT_5_DIMS_ND               {3,1}
...
/* Output Port  6 */
#define OUT_PORT_6_NAME                vel_acc
#define OUTPUT_6_DIMS_ND               {3,1}
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port alt_acc of S-Function pos_est_sf");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port vel_acc of S-Function pos_est_sf");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  real_T *alt_acc = (real_T *) ssGetOutputPortRealSignal(S, 5);
  real_T *vel_acc = (real_T *) ssGetOutputPortRealSignal(S, 6);
  ...
  pos_est_sf_Outputs_wrapper(&_MagBUS, &_BaroBUS, &_GPSBUS, &_IMUBUS, pos, vel,
    att, att_acc_mag, att_gyro, alt_acc, vel_acc);
