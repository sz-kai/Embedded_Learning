 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Nov 13 21:49:43 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                my_c_gain
...
extern void my_c_gain_Outputs_wrapper(const real_T *u0,
  real_T *y0,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u0 of S-Function my_c_gain");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function my_c_gain");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real_T *k0 = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  my_c_gain_Outputs_wrapper(u0, y0, k0, p_width0);
}
