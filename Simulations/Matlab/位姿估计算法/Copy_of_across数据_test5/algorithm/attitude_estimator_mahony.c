...
static float q0 = 1.0f, q1 = 0.0f, q2 = 0.0f, q3 = 0.0f; //机体坐标系相对地理坐标系的姿�?
...
void imuInit(void)
{
  ...
  initialRoll = atan2f(-Ctrl_state.accf.y, -Ctrl_state.accf.z);//根据加速度算�?�度
...
//		attitude_roll = atan2f(-Ctrl_state.accf.y, -Ctrl_state.accf.z);//根据加速度算�?�度
