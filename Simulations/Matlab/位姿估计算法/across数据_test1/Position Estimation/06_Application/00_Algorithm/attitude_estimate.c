 ...
 * @retval 无
 */
static void quaternion_to_euler(const Mahony_Param_t *M_P, __IO Euler_u *el)
{
    // /*滚转角(-180°~180°)*/
 ...
 * @retval 无
 */
static void attitude_estimate_acc_mag_update(__IO Axis3_f_u *acc, __IO Axis3_f_u *mag, __IO Euler_Test_t *el_out)
{
    el_out->tick = GetTick();
 ...
 * @retval 无
 */
void attitude_estimate_update(Attitude_Estimate_t *att_est, __IO Flight_Control_State_t *flgt_ctl)
{
    /*mahony姿态解算*/
