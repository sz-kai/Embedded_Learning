...
#define ENABLE_ACC_MAG_GYRO_ATTITUDE_ESTIMATE 1
...
void attitude_estimate_update(Attitude_Estimate_t* att_est,volatile Sensor_t *sensor);
void att_est_get_euler(const Attitude_Estimate_t *att_est, volatile Euler_u *el);
void att_est_get_data(const Attitude_Estimate_t *att_est, volatile attitude_t *attitude);
