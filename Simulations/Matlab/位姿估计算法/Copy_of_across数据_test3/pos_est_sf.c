 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Nov 23 17:19:48 2025
 */
...
/* Input Port  4 */
#define IN_PORT_4_NAME                 GPS
#define INPUT_4_DIMS_ND                {10,1}
#define INPUT_4_NUM_ELEMS              10
#define INPUT_4_WIDTH                  10
...
/* Output Port  3 */
#define OUT_PORT_3_NAME                angle_acc_mag
...
/* Output Port  4 */
#define OUT_PORT_4_NAME                angle_gyro
...
extern void pos_est_sf_Outputs_wrapper(const real_T *Acc,
  const real_T *Gyro,
  const real_T *Mag,
  const real32_T *Baro,
  const real_T *GPS,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Acc of S-Function pos_est_sf");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Gyro of S-Function pos_est_sf");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port angle of S-Function pos_est_sf");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port angle_acc_mag of S-Function pos_est_sf");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port angle_gyro of S-Function pos_est_sf");
      return;
    }
...
{
  const real_T *Acc = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *Gyro = (real_T *) ssGetInputPortRealSignal(S, 1);
  const real_T *Mag = (real_T *) ssGetInputPortRealSignal(S, 2);
  const real32_T *Baro = (real32_T *) ssGetInputPortRealSignal(S, 3);
  const real_T *GPS = (real_T *) ssGetInputPortRealSignal(S, 4);
  real_T *pos = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *vel = (real_T *) ssGetOutputPortRealSignal(S, 1);
  real_T *angle = (real_T *) ssGetOutputPortRealSignal(S, 2);
  real_T *angle_acc_mag = (real_T *) ssGetOutputPortRealSignal(S, 3);
  real_T *angle_gyro = (real_T *) ssGetOutputPortRealSignal(S, 4);
  pos_est_sf_Outputs_wrapper(Acc, Gyro, Mag, Baro, GPS, pos, vel, angle,
    angle_acc_mag, angle_gyro);
}
