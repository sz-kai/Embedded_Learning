...
flgt_ctl.sensor.acc.x = Acc[0];
    ...
    angle[0] = flgt_ctl.attitude.euler.roll;
    angle[1] = flgt_ctl.attitude.euler.pitch;
    angle[2] = flgt_ctl.attitude.euler.yaw;

    angle_acc_mag[0] = acc_mag_euler.roll;
    angle_acc_mag[1] = acc_mag_euler.pitch;
    angle_acc_mag[2] = acc_mag_euler.yaw;

    angle_gyro[0] = gyro_euler.roll;
    angle_gyro[1] = gyro_euler.pitch;
    angle_gyro[2] = gyro_euler.yaw;
